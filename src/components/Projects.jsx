...
const Projects = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Projects | Sriram Vissakoti</title>
        <meta name="description" content="A selection of projects by Sriram Vissakoti including web apps, animations, and experiments." />
        <link rel="canonical" href="/projects" />
        <meta property="og:title" content="Projects | Sriram Vissakoti" />
        <meta property="og:description" content="Explore my recent work: web apps, UI/UX, and interactive experiences." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="/projects" />
        <meta property="og:image" content="/profile_pic.jpg" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Projects | Sriram Vissakoti" />
        <meta name="twitter:description" content="Explore my recent work: web apps, UI/UX, and interactive experiences." />
