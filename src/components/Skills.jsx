...
const Skills = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Skills | Sriram Vissakoti</title>
        <meta name="description" content="Technologies and tools I use: React, JS, Python, databases, tooling and more." />
        <link rel="canonical" href="/skills" />
        <meta property="og:title" content="Skills | Sriram Vissakoti" />
        <meta property="og:description" content="Explore my toolkit across frontend, backend, and tooling." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="/skills" />
        <meta property="og:image" content="/profile_pic.jpg" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Skills | Sriram Vissakoti" />
        <meta name="twitter:description" content="Explore my toolkit across frontend, backend, and tooling." />
      ...
      <div className="relative z-20 flex justify-center gap-4 flex-wrap max-w-5xl w-full">
        {icons.map((icon, index) => (
          <div key={index} className="group flex flex-col items-center" title={labels[index]} aria-label={labels[index]}>
            <CardSpotlight
            ...
            <div className="mt-2 text-xs sm:text-sm text-neutral-300 opacity-0 group-hover:opacity-100 transition-opacity select-none text-center whitespace-nowrap">
              {labels[index]}
            </div>
          </div>
        ))}
