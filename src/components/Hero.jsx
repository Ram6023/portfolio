...
import { SiHackerrank, SiCodeforces } from "react-icons/si";
      ...
      <div className="relative flex min-h-[50rem] md:min-h-screen w-full items-center justify-center bg-black overflow-hidden px-4 py-16">
        ...
        <div className="relative z-20 text-center">
          ...
          <div className="flex justify-center gap-4 mt-6 text-2xl">
            ...
            <a
              href="https://www.hackerrank.com/profile/sriramnaidu799"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="HackerRank profile"
              className="icon-circle hover:text-green-500 transition"
            >
              <SiHackerrank />
            </a>
            <a
